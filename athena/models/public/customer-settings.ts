...
export type PublicCustomerSettingsUpdate = Partial<PublicCustomerSettingsInsert>

export const publicCustomerSettingsModel = defineModel<PublicCustomerSettingsRow, PublicCustomerSettingsInsert, PublicCustomerSettingsUpdate>({
  meta: {
    database: 'railway',
    schema: 'public',
