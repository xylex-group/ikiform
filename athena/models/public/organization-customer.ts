...
export type PublicOrganizationCustomerInsert =
	Partial<PublicOrganizationCustomerRow>;
export type PublicOrganizationCustomerUpdate =
	Partial<PublicOrganizationCustomerInsert>;

export const publicOrganizationCustomerModel = defineModel<
	PublicOrganizationCustomerRow,
	PublicOrganizationCustomerInsert,
	PublicOrganizationCustomerUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
