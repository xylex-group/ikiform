...
export type PublicSfFormationsCasesUpdate = Partial<PublicSfFormationsCasesInsert>

export const publicSfFormationsCasesModel = defineModel<PublicSfFormationsCasesRow, PublicSfFormationsCasesInsert, PublicSfFormationsCasesUpdate>({
  meta: {
    database: 'railway',
    schema: 'public',
