...
export type PublicCustomerJurisdictionsInsert = Partial<PublicCustomerJurisdictionsRow>
export type PublicCustomerJurisdictionsUpdate = Partial<PublicCustomerJurisdictionsInsert>

export const publicCustomerJurisdictionsModel = defineModel<PublicCustomerJurisdictionsRow, PublicCustomerJurisdictionsInsert, PublicCustomerJurisdictionsUpdate>({
  meta: {
    database: 'railway',
    schema: 'public',
