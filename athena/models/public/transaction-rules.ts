...
export type PublicTransactionRulesUpdate = Partial<PublicTransactionRulesInsert>

export const publicTransactionRulesModel = defineModel<PublicTransactionRulesRow, PublicTransactionRulesInsert, PublicTransactionRulesUpdate>({
  meta: {
    database: 'railway',
    schema: 'public',
