...
export type PublicWorkflowTemplatesUpdate = Partial<PublicWorkflowTemplatesInsert>

export const publicWorkflowTemplatesModel = defineModel<PublicWorkflowTemplatesRow, PublicWorkflowTemplatesInsert, PublicWorkflowTemplatesUpdate>({
  meta: {
    database: 'railway',
    schema: 'public',
