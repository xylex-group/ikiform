...
export type PublicKanbanInitiativesUpdate =
	Partial<PublicKanbanInitiativesInsert>;

export const publicKanbanInitiativesModel = defineModel<
	PublicKanbanInitiativesRow,
	PublicKanbanInitiativesInsert,
	PublicKanbanInitiativesUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
