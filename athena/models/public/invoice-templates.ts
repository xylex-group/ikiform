...
export type PublicInvoiceTemplatesUpdate =
	Partial<PublicInvoiceTemplatesInsert>;

export const publicInvoiceTemplatesModel = defineModel<
	PublicInvoiceTemplatesRow,
	PublicInvoiceTemplatesInsert,
	PublicInvoiceTemplatesUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
