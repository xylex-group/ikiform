...
export type PublicWorkflowRequirementsInsert =
	Partial<PublicWorkflowRequirementsRow>;
export type PublicWorkflowRequirementsUpdate =
	Partial<PublicWorkflowRequirementsInsert>;

export const publicWorkflowRequirementsModel = defineModel<
	PublicWorkflowRequirementsRow,
	PublicWorkflowRequirementsInsert,
	PublicWorkflowRequirementsUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
