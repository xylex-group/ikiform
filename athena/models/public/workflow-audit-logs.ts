...
export type PublicWorkflowAuditLogsUpdate =
	Partial<PublicWorkflowAuditLogsInsert>;

export const publicWorkflowAuditLogsModel = defineModel<
	PublicWorkflowAuditLogsRow,
	PublicWorkflowAuditLogsInsert,
	PublicWorkflowAuditLogsUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
