...
export type PublicChatSubscriptionsUpdate =
	Partial<PublicChatSubscriptionsInsert>;

export const publicChatSubscriptionsModel = defineModel<
	PublicChatSubscriptionsRow,
	PublicChatSubscriptionsInsert,
	PublicChatSubscriptionsUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
