...
export type PublicWorkflowInstancesUpdate =
	Partial<PublicWorkflowInstancesInsert>;

export const publicWorkflowInstancesModel = defineModel<
	PublicWorkflowInstancesRow,
	PublicWorkflowInstancesInsert,
	PublicWorkflowInstancesUpdate
>({
	meta: {
		database: "railway",
		schema: "public",
