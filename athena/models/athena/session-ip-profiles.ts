...
export type AthenaSessionIpProfilesUpdate =
	Partial<AthenaSessionIpProfilesInsert>;

export const athenaSessionIpProfilesModel = defineModel<
	AthenaSessionIpProfilesRow,
	AthenaSessionIpProfilesInsert,
	AthenaSessionIpProfilesUpdate
>({
	meta: {
		database: "railway",
		schema: "athena",
