...
export type PayloadFormsBlocksPaymentPriceConditionsInsert =
	Partial<PayloadFormsBlocksPaymentPriceConditionsRow>;
export type PayloadFormsBlocksPaymentPriceConditionsUpdate =
	Partial<PayloadFormsBlocksPaymentPriceConditionsInsert>;

export const payloadFormsBlocksPaymentPriceConditionsModel = defineModel<
	PayloadFormsBlocksPaymentPriceConditionsRow,
	PayloadFormsBlocksPaymentPriceConditionsInsert,
	PayloadFormsBlocksPaymentPriceConditionsUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
