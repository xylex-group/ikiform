...
export type PayloadPayloadLockedDocumentsRelsInsert = Partial<PayloadPayloadLockedDocumentsRelsRow>
export type PayloadPayloadLockedDocumentsRelsUpdate = Partial<PayloadPayloadLockedDocumentsRelsInsert>

export const payloadPayloadLockedDocumentsRelsModel = defineModel<PayloadPayloadLockedDocumentsRelsRow, PayloadPayloadLockedDocumentsRelsInsert, PayloadPayloadLockedDocumentsRelsUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
