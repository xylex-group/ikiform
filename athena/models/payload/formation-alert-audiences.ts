...
export type PayloadFormationAlertAudiencesInsert = Partial<PayloadFormationAlertAudiencesRow>
export type PayloadFormationAlertAudiencesUpdate = Partial<PayloadFormationAlertAudiencesInsert>

export const payloadFormationAlertAudiencesModel = defineModel<PayloadFormationAlertAudiencesRow, PayloadFormationAlertAudiencesInsert, PayloadFormationAlertAudiencesUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
