...
export type PayloadDocumentTypesRelsInsert = Partial<PayloadDocumentTypesRelsRow>
export type PayloadDocumentTypesRelsUpdate = Partial<PayloadDocumentTypesRelsInsert>

export const payloadDocumentTypesRelsModel = defineModel<PayloadDocumentTypesRelsRow, PayloadDocumentTypesRelsInsert, PayloadDocumentTypesRelsUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
