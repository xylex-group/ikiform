...
export type PayloadEmailTemplatesBlocksButtonInsert =
	Partial<PayloadEmailTemplatesBlocksButtonRow>;
export type PayloadEmailTemplatesBlocksButtonUpdate =
	Partial<PayloadEmailTemplatesBlocksButtonInsert>;

export const payloadEmailTemplatesBlocksButtonModel = defineModel<
	PayloadEmailTemplatesBlocksButtonRow,
	PayloadEmailTemplatesBlocksButtonInsert,
	PayloadEmailTemplatesBlocksButtonUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
