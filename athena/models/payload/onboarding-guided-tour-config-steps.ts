...
export type PayloadOnboardingGuidedTourConfigStepsInsert =
	Partial<PayloadOnboardingGuidedTourConfigStepsRow>;
export type PayloadOnboardingGuidedTourConfigStepsUpdate =
	Partial<PayloadOnboardingGuidedTourConfigStepsInsert>;

export const payloadOnboardingGuidedTourConfigStepsModel = defineModel<
	PayloadOnboardingGuidedTourConfigStepsRow,
	PayloadOnboardingGuidedTourConfigStepsInsert,
	PayloadOnboardingGuidedTourConfigStepsUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
