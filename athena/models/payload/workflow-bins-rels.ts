...
export type PayloadWorkflowBinsRelsUpdate =
	Partial<PayloadWorkflowBinsRelsInsert>;

export const payloadWorkflowBinsRelsModel = defineModel<
	PayloadWorkflowBinsRelsRow,
	PayloadWorkflowBinsRelsInsert,
	PayloadWorkflowBinsRelsUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
