...
export interface PayloadWorkflowBinsRow {
  ...
  case_state: 'LEAD' | 'INTAKE_STARTED' | 'ELIGIBILITY_CHECKED' | 'DOCUMENTS_GENERATED' | 'ID_VERIFIED' | 'POA_PENDING' | 'NOTARY_SCHEDULED' | 'SUBMITTED_TO_REGISTRY' | 'TAX_REGISTERED' | 'COMPLETED' | 'REJECTED'
  order: string
...
export const payloadWorkflowBinsModel = defineModel<PayloadWorkflowBinsRow, PayloadWorkflowBinsInsert, PayloadWorkflowBinsUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
    model: 'workflow_bins',
