...
export interface PayloadFormsDynamicSectionsFieldsRow {
  ...
  field_id: string
  label: string
  field_type: 'text' | 'textarea' | 'number' | 'email' | 'tel' | 'date' | 'select' | 'radio' | 'checkbox' | 'password'
...
export type PayloadFormsDynamicSectionsFieldsInsert = Partial<PayloadFormsDynamicSectionsFieldsRow>
export type PayloadFormsDynamicSectionsFieldsUpdate = Partial<PayloadFormsDynamicSectionsFieldsInsert>

export const payloadFormsDynamicSectionsFieldsModel = defineModel<PayloadFormsDynamicSectionsFieldsRow, PayloadFormsDynamicSectionsFieldsInsert, PayloadFormsDynamicSectionsFieldsUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
