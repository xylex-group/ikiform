...
export type PayloadMollieCustomersUpdate =
	Partial<PayloadMollieCustomersInsert>;

export const payloadMollieCustomersModel = defineModel<
	PayloadMollieCustomersRow,
	PayloadMollieCustomersInsert,
	PayloadMollieCustomersUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
