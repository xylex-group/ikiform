...
export type PayloadFormsBlocksStateUpdate = Partial<PayloadFormsBlocksStateInsert>

export const payloadFormsBlocksStateModel = defineModel<PayloadFormsBlocksStateRow, PayloadFormsBlocksStateInsert, PayloadFormsBlocksStateUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
