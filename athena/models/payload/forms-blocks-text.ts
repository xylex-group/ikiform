...
export type PayloadFormsBlocksTextUpdate =
	Partial<PayloadFormsBlocksTextInsert>;

export const payloadFormsBlocksTextModel = defineModel<
	PayloadFormsBlocksTextRow,
	PayloadFormsBlocksTextInsert,
	PayloadFormsBlocksTextUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
