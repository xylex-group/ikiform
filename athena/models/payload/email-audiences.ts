...
export interface PayloadEmailAudiencesRow {
  ...
  scope: 'all-customers' | 'formation-customers' | 'formation-forms' | 'specific-emails'
...
export const payloadEmailAudiencesModel = defineModel<PayloadEmailAudiencesRow, PayloadEmailAudiencesInsert, PayloadEmailAudiencesUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
