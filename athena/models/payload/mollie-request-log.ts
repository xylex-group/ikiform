...
export type PayloadMollieRequestLogUpdate = Partial<PayloadMollieRequestLogInsert>

export const payloadMollieRequestLogModel = defineModel<PayloadMollieRequestLogRow, PayloadMollieRequestLogInsert, PayloadMollieRequestLogUpdate>({
  meta: {
    database: 'railway',
    schema: 'payload',
