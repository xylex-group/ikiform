...
export type PayloadFormSubmissionsUpdate =
	Partial<PayloadFormSubmissionsInsert>;

export const payloadFormSubmissionsModel = defineModel<
	PayloadFormSubmissionsRow,
	PayloadFormSubmissionsInsert,
	PayloadFormSubmissionsUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
