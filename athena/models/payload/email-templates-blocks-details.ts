...
export type PayloadEmailTemplatesBlocksDetailsInsert =
	Partial<PayloadEmailTemplatesBlocksDetailsRow>;
export type PayloadEmailTemplatesBlocksDetailsUpdate =
	Partial<PayloadEmailTemplatesBlocksDetailsInsert>;

export const payloadEmailTemplatesBlocksDetailsModel = defineModel<
	PayloadEmailTemplatesBlocksDetailsRow,
	PayloadEmailTemplatesBlocksDetailsInsert,
	PayloadEmailTemplatesBlocksDetailsUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
