...
export type PayloadFormsBlocksPaymentInsert =
	Partial<PayloadFormsBlocksPaymentRow>;
export type PayloadFormsBlocksPaymentUpdate =
	Partial<PayloadFormsBlocksPaymentInsert>;

export const payloadFormsBlocksPaymentModel = defineModel<
	PayloadFormsBlocksPaymentRow,
	PayloadFormsBlocksPaymentInsert,
	PayloadFormsBlocksPaymentUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
