...
export type PayloadMollieChargebacksInsert =
	Partial<PayloadMollieChargebacksRow>;
export type PayloadMollieChargebacksUpdate =
	Partial<PayloadMollieChargebacksInsert>;

export const payloadMollieChargebacksModel = defineModel<
	PayloadMollieChargebacksRow,
	PayloadMollieChargebacksInsert,
	PayloadMollieChargebacksUpdate
>({
	meta: {
		database: "railway",
		schema: "payload",
