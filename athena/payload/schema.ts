...
export const payloadSchema = defineSchema({
  ...
  email_templates_blocks_bullet_list: payloadEmailTemplatesBlocksBulletListModel,
  email_templates_blocks_bullet_list_items: payloadEmailTemplatesBlocksBulletListItemsModel,
  ...
  email_templates_blocks_details_rows: payloadEmailTemplatesBlocksDetailsRowsModel,
  ...
  formation_access_groups_formations_ids: payloadFormationAccessGroupsFormationsIdsModel,
  formation_access_groups_granted_user_ids: payloadFormationAccessGroupsGrantedUserIdsModel,
  ...
  forms_blocks_payment_price_conditions: payloadFormsBlocksPaymentPriceConditionsModel,
  ...
  forms_dynamic_sections_fields_options: payloadFormsDynamicSectionsFieldsOptionsModel,
  ...
  mollie_payment_links_stacked_products: payloadMolliePaymentLinksStackedProductsModel,
  mollie_payment_links_stacked_upsells: payloadMolliePaymentLinksStackedUpsellsModel,
  ...
  onboarding_guided_tour_config_steps: payloadOnboardingGuidedTourConfigStepsModel,
