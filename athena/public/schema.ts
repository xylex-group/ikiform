...
export const publicSchema = defineSchema({
  ...
  mollie_payment_links_stacked_products: publicMolliePaymentLinksStackedProductsModel,
  mollie_payment_links_stacked_upsells: publicMolliePaymentLinksStackedUpsellsModel,
