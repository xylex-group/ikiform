...
function Avatar({
	...
	return (
		<AvatarPrimitive.Root
			className={cn(
				"group/avatar relative flex size-8 shrink-0 select-none overflow-hidden rounded-full bg-muted ring-1 ring-border/70 data-[size=lg]:size-10 data-[size=sm]:size-6",
				className
			)}
			data-size={size}
			data-slot="avatar"
...
function AvatarFallback({
	...
	return (
		<AvatarPrimitive.Fallback
			className={cn(
				"flex size-full items-center justify-center rounded-full bg-muted font-medium text-foreground text-sm group-data-[size=sm]/avatar:text-xs",
				className
			)}
